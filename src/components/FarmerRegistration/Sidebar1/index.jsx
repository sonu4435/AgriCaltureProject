...
export default function Sidebar1({ ...props }) {
  return (
    <Sidebar {...props} width="250px !important">
      <Img src="/public/Fimages/img_group_18298.svg" alt="image" className="h-[30px] mt-6 ml-7 mr-[97px]" />
      <Menu
        menuItemStyles={{
          button: {
            padding: " ",
        ...
        renderExpandIcon={() => (
          <Img src="/public/Fimages/img_arrow_right.svg" alt="arrowright_one" className="h-6 w-6 cursor-pointer" />
        )}
      ...
      >
        <div className="flex flex-row justify-start items-center w-full gap-2 p-2.5">
          <Img src="/public/Fimages/img_circlesfour_blue_gray_400.svg" alt="image_one" className="h-5 w-5 ml-5" />
        ...
        <SubMenu>
          <div className="flex flex-row justify-between items-center w-full p-[7px]">
            <div className="flex flex-row justify-start items-center ml-[23px] gap-2">
              <Img src="/public/Fimages/img_frame_17.svg" alt="rocketlaunch" className="h-4 w-4" />
        ...
        <SubMenu>
          <div className="flex flex-row justify-between items-start w-full pt-2.5 px-2.5">
            <div className="flex flex-row justify-start items-center ml-[19px] gap-2">
              <Img src="/public/Fimages/defaultNoData.png" alt="image_two" className="h-4 w-4" />
              <Text as="p">Menus</Text>
            </div>
            <Img src="/public/Fimages/img_arrow_right.svg" alt="arrowright" className="h-6 w-6 mt-2.5 cursor-pointer" />
          </div>
        </SubMenu>
        <SubMenu>
          <div className="flex flex-row justify-between items-start w-full pb-2.5 px-2.5">
            <div className="flex flex-row justify-start items-center mt-2.5 ml-[19px] gap-[7px]">
              <Img src="/public/Fimages/defaultNoData.png" alt="vector_one" className="h-4 w-4" />
              <Text as="p" className="!text-blue-A200">
                Customer
              </Text>
            </div>
            <div className="h-6 w-6 mb-[22px] mr-[23px] rotate-[90deg]" />
          </div>
        ...
        <div className="flex flex-row justify-start items-center w-full mt-[59px] gap-2 p-2.5">
          <Img src="/public/Fimages/img_frame_20.svg" alt="vector_three" className="h-4 w-4 ml-[19px]" />
          <Text as="p">Analytics</Text>
        </div>
        <SubMenu>
          <div className="flex flex-row justify-between items-center w-full p-2">
            <div className="flex flex-row justify-start items-center ml-[22px] gap-2">
              <Img src="/public/Fimages/img_frame_21.svg" alt="image_three" className="h-4 w-4" />
              <Text as="p">Table </Text>
            </div>
            <Img src="/public/Fimages/img_arrow_right.svg" alt="arrowright_five" className="h-6 w-6 cursor-pointer" />
          </div>
        </SubMenu>
      </Menu>
      <div className="flex flex-col items-start justify-start w-full mt-[170px] mb-[5px] mx-auto max-w-[189px]">
        <Img src="/public/Fimages/defaultNoData.png" alt="image_four" className="w-full object-cover" />
        ...
        <div className="flex flex-row justify-start mt-[5px] gap-0.5">
          ...
          <Img src="/public/Fimages/img_heart.svg" alt="heart_one" className="h-3" />
          <Text size="xs" as="p" className="!text-gray-700_01">
            by Bistro
          </Text>
        </div>
