...
export default function Sidebar3({ ...props }) {
  return (
    <Sidebar {...props} width="249px !important">
      <Img src="/public/Fimages/img_group_18298.svg" alt="image" className="h-[30px] mt-6 ml-[27px] mr-[97px]" />
      <Menu
        menuItemStyles={{
          button: {
            padding: " ",
      ...
      >
        <div className="flex flex-row justify-start items-center w-full gap-2 p-2.5">
          <Img src="/public/Fimages/img_circlesfour_blue_gray_400.svg" alt="image_one" className="h-5 w-5 ml-[19px]" />
        ...
        <SubMenu>
          <div className="flex flex-row justify-between items-start w-full pt-2.5 px-2.5">
            <div className="flex flex-row justify-start items-center ml-[18px] gap-2">
              <Img src="/public/Fimages/img_frame_19.svg" alt="vector_one" className="h-4 w-4" />
              <Text as="p">Customer</Text>
            </div>
            <Img src="/public/Fimages/img_arrow_right.svg" alt="arrowright_five" className="h-6 w-6 mt-[22px] cursor-pointer" />
          </div>
        </SubMenu>
        <div className="flex flex-row justify-start items-center w-full mt-[49px] gap-2 p-2.5">
          <Img src="/public/Fimages/img_frame_20.svg" alt="vector_three" className="h-4 w-4 ml-[18px]" />
          <Text as="p">Analytics</Text>
        </div>
        <SubMenu>
          <div className="flex flex-row justify-between items-center w-full p-2">
            <div className="flex flex-row justify-start items-center ml-[21px] gap-2">
              <Img src="/public/Fimages/defaultNoData.png" alt="image_three" className="h-4 w-4" />
